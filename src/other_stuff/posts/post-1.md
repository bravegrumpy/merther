...
A counterexample is [dabric](https://dabric.xyz/).  I think this may ultimately be because of the mental models that a coder uses, that is different than that of an artist. An artist is likely to think "I like this aesthetic", however a coder, especially one familiar with WAI-ARIA standards, or are using a framework that encourages good web practices, is more likely to make readable text, and use components, etc. 